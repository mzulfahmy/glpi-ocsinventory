...
$sql = "SELECT id,computers_id,softwareversions_id FROM glpi_computers_softwareversions WHERE date_install='0000-00-00' AND is_deleted_computer='0' LIMIT ".getCurrentNumbers()." OFFSET ".(getCurrentNumbers() * 4);
