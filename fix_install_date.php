...
$sql = "SELECT id,computers_id,softwareversions_id FROM glpi_computers_softwareversions WHERE date_install='0000-00-00' AND is_deleted_computer='0'";
...
while( $row = mysqli_fetch_assoc($q1)) {
	...
	if($ocs_install_date != '') {
		...
		echo "Updated id " . $row['id'] . " with date " . $ocs_install_date . "\n";
	}
}
